 ...
 * access.
 */
public class RunSampleQueryWithoutSrcSel extends CmdARQ
{
	...
	public static void main( final String[] argv ) {
		new RunSampleQueryWithoutSrcSel( argv ).mainRun();
	}
	 ...
	 * @param argv Command-line arguments.
	 */
	public RunSampleQueryWithoutSrcSel(final String[] argv ) {
		super( argv );
